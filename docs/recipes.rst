...
Listening to Events
-------------------
WaveLink 2 makes use of the built in event dispatcher of disnake.
...
.. code:: python3
    ...
    @commands.command()
    async def connect(self, ctx: commands.Context, *, channel: disnake.VoiceChannel | None = None):
        try:
...
.. code:: python3
    ...
    class Player(wavelink.Player):
        ...
        def __init__(self, dj: disnake.Member, *args: Any, **kwargs: Any):
