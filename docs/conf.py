...
ogp_description = "Documentation for Wavelink, the Powerful Lavalink wrapper for disnake."
ogp_site_url = "https://wavelink.dev/"
ogp_custom_meta_tags = [
    '<meta property="og:description" content="Wavelink is a robust and powerful Lavalink wrapper for disnake. '
...
extlinks = {
    ...
    'ddocs': ('https://disnake.com/developers/docs/%s', None),
}
