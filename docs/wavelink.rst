...
Wavelink is a robust and powerful Lavalink wrapper for disnake. Featuring,
...
.. attributetable:: disnakeVoiceCloseType

.. autoclass:: disnakeVoiceCloseType
    :members:
...
.. py:exception:: InvalidChannelStateError
    ...
    Base exception raised when an error occurs trying to connect to a :class:`disnake.VoiceChannel`.
